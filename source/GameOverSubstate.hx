...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		DiscordClient.changePresence("DEAD LOL WHAT A LOSER", null, 'sussy', 'racialdiversity');
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			else if (PlayState.isWeekend || PlayState.weekEndFreeplay)
				FlxG.switchState(new WeekendMenuState());
			else if (PlayState.randomLevel)
